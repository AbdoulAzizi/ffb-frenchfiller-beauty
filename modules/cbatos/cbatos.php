...
/*				self::CNF_DATA_CONTROLS => array(
	...
	public function getContent()
	{
		...
		<dl>
			...
			'.$this->l('1/ Munissez vous de votre certificat de production (envoyé par la banque ou a télecharger) Si vous téléchargez, utilisez le format classique et non pas php ou jsp.').' <br />
			'.$this->l('1/ Chargez le certificat dans le dossier param du module (format certif.fr.xxxxxxxxx ou xxx est votre identifiant marchand ou numéro de siret').'<br />
			'.$this->l('3/ Renommez ce fichier si nécesaire dans la forme identique aux fichiers de demonstration.').'<br />
			'.$this->l('4/ Passez tout le module en chmod 755 récursif par FTP et verifiez').'<br />
			...
			'.$this->l('1a/Verifiez que la fonction exec() est bien autorisée sur votre serveur ou demandez à votre hébergeur.').' <br />
			'.$this->l('2a/Regardez si il n y a pas un dossier cgi-bin a la racine de votre hébergement.').' <br />
			...
			'.$this->l('----------------------').'<br />
			'.$this->l('REQUIS POUR FONCTIONNER : La fonction exec() , php version 5.3 ou supérieur, Prestahop 1.7.0 ou supérieur, php safe_mode off').'<br />
			'.$this->l('Si un probleme persiste contactez nous en précisant le message erreur indiqué.').'<br />
			'.$this->l('Lisez bien la documentation ATOS envoyée par votre banque.Vous devez effectuer un test avec votre certificat avant de demander la mise en production en remplissant le pv de recette.').'<br />
