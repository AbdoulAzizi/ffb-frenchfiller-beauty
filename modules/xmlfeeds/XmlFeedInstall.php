...
class XmlFeedInstall
{
    ...
    public function installDefaultFeedProductSettings($feed_id = false, $feedMode = 'c')
    {
        ...
        $fields['vi'] = '
            ...
            ("id_product", 1, "extras/product-id", "product", "' . $feed_id . '"),
            ("price_sale_blmod", 1, "price", "bl_extra", "' . $feed_id . '"),
            ("product_url_blmod", 1, "link", "bl_extra", "' . $feed_id . '"),
        ...
        $options['s'] = 'one_branch = "1", html_tags_status = "0", feed_generation_time = "1", feed_generation_time_name = "created_at", in_stock_text = "Available in store / Delivery 1 to 3 days", out_of_stock_text = "Delivery 4 to 10 days"';
        $options['i'] = 'header_information = "' . htmlspecialchars('<rss xmlns:g="http://base.google.com/ns/1.0" xmlns:s="https://merchants.siroop.ch/" version="2.0">', ENT_QUOTES) . '",
			footer_information = "' . htmlspecialchars('</rss>', ENT_QUOTES) . '", one_branch = "1", price_with_currency = "1"';
        $options['x'] = 'all_images = "1", filter_image = "1", in_stock_text = "1", out_of_stock_text = "0"';
        $options['r'] = 'one_branch = "1", all_images = "0", in_stock_text = "INSTOCK", out_of_stock_text = "OUTOFSTOCK"';
        ...
        $options['o'] = 'all_images = "1", cdata_status = "0", in_stock_text = "Skladem", out_of_stock_text = "Skladem za 14 dní"';
        $options['e'] = 'one_branch = "1", all_images = "0", cdata_status = "1", in_stock_text = "1 tot 3 werkdagen", out_of_stock_text = "4 tot 10 werkdagen"';
        $options['p'] = 'one_branch = "1", price_with_currency = "1"';
        ...
        $options['dre'] = 'one_branch = "1", all_images = "0", cdata_status = "0"';
        $options['cen'] = 'one_branch = "1", all_images = "0", cdata_status = "0"';
        ...
        $options['k24'] = 'one_branch = "1", all_images = "0", cdata_status = "0", in_stock_text = "2", out_of_stock_text = "30"';
        $options['kos'] = 'one_branch = "1", all_images = "0", cdata_status = "0", in_stock_text = "2", out_of_stock_text = "30"';
        $options['plt'] = 'one_branch = "1", all_images = "0", cdata_status = "0", in_stock_text = "0-2", out_of_stock_text = "30-90"';
        $options['aru'] = 'one_branch = "1", all_images = "0", cdata_status = "0", in_stock_text = "Доставка: до 3 дн", out_of_stock_text = "Доставка: над 2 седмици"';
        $options['epr'] = 'header_information = "' . htmlspecialchars('<import>', ENT_QUOTES) . '",
			footer_information = "' . htmlspecialchars('</import>', ENT_QUOTES) . '", one_branch = "1"';
        $options['sez'] = 'one_branch = "1", all_images = "0", cdata_status = "0", in_stock_text = "1-3 (do 3 dnů)", out_of_stock_text = "8 a více (více jak týden)"';
        $options['pri'] = 'one_branch = "1", all_images = "0", cdata_status = "0", in_stock_text = "in_stock", out_of_stock_text = "not_in_stock"';
        $options['mal'] = 'one_branch = "1", all_images = "1", cdata_status = "0", in_stock_text = "0", out_of_stock_text = "14"';
        $options['spa'] = 'one_branch = "1", all_images = "1", cdata_status = "0", header_information = "'.htmlspecialchars('<root>', ENT_QUOTES).'", footer_information = "'.htmlspecialchars('</root>', ENT_QUOTES).'"';
        $options['lw'] = 'one_branch = "1", html_tags_status = "0", feed_generation_time = "1", feed_generation_time_name = "created_at", in_stock_text = "Available in store / Delivery 1 to 3 days", out_of_stock_text = "Delivery 4 to 10 days"';
        $options['naj'] = 'one_branch = "1", all_images = "0", cdata_status = "0", in_stock_text = "skladom", out_of_stock_text = "na otázku"';
        $options['tot'] = 'one_branch = "1", all_images = "0", cdata_status = "0", in_stock_text = "Διαθέσιμο", out_of_stock_text = "δεν υπάρχει", header_information = "'.htmlspecialchars('<catalog>', ENT_QUOTES).'", footer_information = "'.htmlspecialchars('</catalog>', ENT_QUOTES).'"';
        $options['ceo'] = 'one_branch = "1", all_images = "1", cdata_status = "0", in_stock_text = "1", out_of_stock_text = "7", header_information = "'.htmlspecialchars('<offers xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="1">', ENT_QUOTES).'", footer_information = "'.htmlspecialchars('</offers>', ENT_QUOTES).'"';
        $options['bil'] = 'one_branch = "1", all_images = "0", cdata_status = "0", in_stock_text = "1-3 days", out_of_stock_text = "20-30 days"';
        $options['man'] = 'one_branch = "1", all_images = "0", cdata_status = "1", in_stock_text = "2", out_of_stock_text = "50"';
        $options['sal'] = 'one_branch = "1", all_images = "0"';
        $options['hinn'] = 'one_branch = "1", all_images = "0"';
        $options['wum'] = 'one_branch = "1", all_images = "0", header_information = "'.htmlspecialchars('<wumler_feed version="0.1" language="en" currency="EUR">', ENT_QUOTES).'", footer_information = "'.htmlspecialchars('</wumler_feed>', ENT_QUOTES).'"';
        $options['mala'] = 'one_branch = "1", all_images = "1", split_by_combination = "1"';
        $options['cr'] = 'one_branch = "1", all_images = "0", split_by_combination = "0", price_format_id = "2"';
        $options['tov'] = 'one_branch = "1", all_images = "0"';
        $options['che'] = 'one_branch = "1", all_images = "0", price_format_id = "2"';
        $options['kie'] = 'one_branch = "1", all_images = "0"';
        $options['kog'] = 'one_branch = "1", all_images = "1", in_stock_text = "3", out_of_stock_text = "14"';
        $options['mir'] = 'one_branch = "1", all_images = "0"';
        ...
        $options['ar'] = 'one_branch = "1", all_images = "0", in_stock_text = "2-3 nap", out_of_stock_text = "10-14 nap", price_format_id="4"';
        ...
        $options['ek'] = 'one_branch = "1", all_images = "0", in_stock_text = "2-3", out_of_stock_text = "10-14"';
        $options['kuk'] = 'one_branch = "1", all_images = "0", in_stock_text = "Y", out_of_stock_text = "N"';
        $options['dot'] = 'one_branch = "1", all_images = "0"';
        $options['pem'] = 'one_branch = "1", all_images = "0"';
        $options['cb'] = 'one_branch = "1", all_images = "0"';
        $options['gu'] = 'one_branch = "1", all_images = "0"';
        $options['sn'] = 'one_branch = "1", all_images = "0", in_stock_text = "In stock", out_of_stock_text = "Out of stock", price_with_currency = "1"';
        $options['gp'] = 'one_branch = "1", all_images = "0"';
        $options['sco'] = 'one_branch = "1", all_images = "0"';
        $options['lbb'] = 'one_branch = "1", all_images = "0"';
        $options['ec'] = 'one_branch = "1", all_images = "0", in_stock_text = "1-3 days", out_of_stock_text = "7-14 days"';
        $options['no'] = 'one_branch = "1", all_images = "0", in_stock_text = "0", out_of_stock_text = "1", 
        ...
        $options['gd'] = 'one_branch = "1", all_images = "0"';
