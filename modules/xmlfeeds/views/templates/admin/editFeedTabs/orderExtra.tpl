...
<table border="0" width="100%" cellpadding="3" cellspacing="0">
    <tr>
        ...
        <td width="200"><b>{l s='Filter by status:' mod='xmlfeeds'}</b></td>
        <td>
    ...
    <tr>
        ...
        <td width="200"><b>{l s='Filter by payments:' mod='xmlfeeds'}</b></td>
        <td>
            <script type="text/javascript">
                $(document).ready(function() {
    ...
    <tr>
        <td width="20"><img src="{$moduleImgPath|escape:'htmlall':'UTF-8'}date.png" /></td>
        <td width="200"><b>{l s='Filter by date:' mod='xmlfeeds'}</b></td>
        <td>
            ...
            <div {if $s.filter_date_type != $FILTER_DATE_CUSTOM_DAYS} style="display: none;" {/if}id="order-filter-custom-days" class="blmod_mt10">
                <input style="width: 50px;" type="text" name="filter_custom_days" value="{if $s.filter_custom_days}{$s.filter_custom_days|escape:'htmlall':'UTF-8'}{/if}"> {l s='days from today' mod='xmlfeeds'}
            </div>
        </td>
    </tr>
</table>