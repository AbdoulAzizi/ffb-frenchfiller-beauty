...
<div class="cb"></div>
<div style="float: left; width: 190px; font-weight: bold;">{l s='Description block name:' mod='xmlfeeds'}</div><div style="float: left;"><input type="text" {$disabled_branch_name} name="desc-block-name" value="{$b_name['desc-block-name']|escape:'htmlall':'UTF-8'}" size="30"/></div>
<br/><br/>