...
<div class="cn_table">
    ...
    <div class="cn_line block-name-box">
        <div class="cn_name">{l s='File name' mod='xmlfeeds'}</div>
        <div class="cn_status">
            <label for="file-name">
        ...
        <div class="cn_name_xml" style="float: right;">
            <input style="width: 220px;" type="text" name="file-name" value="{$b_name['file-name']|escape:'htmlall':'UTF-8'}" />
        </div>
    </div>
</div>
<div class="cb"></div>
<div class="cn_name-block-name">{l s='Product' mod='xmlfeeds'}</div>
<div style="float: right;"><input style="width: 220px;" type="text" name="cat-block-name" value="{$b_name['cat-block-name']|escape:'htmlall':'UTF-8'}"/></div>
<div class="cb"></div>
<div class="cn_name-block-name">{l s='Description' mod='xmlfeeds'}</div>
<div style="float: right;"><input style="width: 220px;" {$disabled_branch_name} type="text" name="desc-block-name" value="{$b_name['desc-block-name']|escape:'htmlall':'UTF-8'}" /></div>
<div class="cb"></div>
<div class="cn_name-block-name">{l s='Images' mod='xmlfeeds'}</div>
<div style="float: right;"><input style="width: 220px;" {$disabled_branch_name} type="text" name="img-block-name" value="{$b_name['img-block-name']|escape:'htmlall':'UTF-8'}"/></div>
<div class="cb"></div>
<div class="cn_name-block-name">{l s='Default category' mod='xmlfeeds'}</div>
<div style="float: right;"><input style="width: 220px;" {$disabled_branch_name} type="text" name="def_cat-block-name" value="{$b_name['def_cat-block-name']|escape:'htmlall':'UTF-8'}"/></div>
<div class="cb"></div>
<div class="cn_name-block-name">{l s='Attributes' mod='xmlfeeds'}</div>
<div style="float: right;"><input style="width: 220px;" {$disabled_branch_name} type="text" name="attributes-block-name" value="{$b_name['attributes-block-name']|escape:'htmlall':'UTF-8'}"/></div>
<div class="cb"></div>
<div class="cn_name-block-name" style="width: 285px;">{l s='Extra product rows' mod='xmlfeeds'}</div>
...
{if $settings.feed_mode == 'pub'}
    <div style="float: left; width: 285px;">{l s='Extra offer rows' mod='xmlfeeds'}</div>
    <div style="float: right; width: 295px;">
...
<div class="info-small-blmod">
    ...
    {l s='Please use' mod='xmlfeeds'} "<a target="_blank" href="{$fullAdminUrl|escape:'htmlall':'UTF-8'}&add_affiliate_price=1">{l s='Affiliate price' mod='xmlfeeds'}</a>" {l s='feature if you need to modify prices' mod='xmlfeeds'}
</div>