...
<div class="panel">
    ...
    <div class="row">
        <form action="{$requestUri|escape:'htmlall':'UTF-8'}" method="post">
            ...
            <center>
                <input style="text-align: center; margin-top: 20px;" class="button" type="submit" name="create_product_property_map" value="{l s='Create new' mod='xmlfeeds'}">
...
<div class="panel">
    ...
    <div class="row">
        <form style="border-bottom: solid 1px #EAEDEF; margin-bottom: 10px;" action="{$requestUri|escape:'htmlall':'UTF-8'}" method="post">
            {if !empty($mapList)}
                <input style="float: right;" class="button" type="submit" name="select_product_property_map" value="{l s='Select' mod='xmlfeeds'}">
            {/if}
        ...
        <form action="{$requestUri|escape:'htmlall':'UTF-8'}" method="post">
            {if !empty($mapId)}
                ...
                <input style="float: right;" type="submit" name="update_product_property_map" value="Update" class="button">
                <div class="cb"></div>
