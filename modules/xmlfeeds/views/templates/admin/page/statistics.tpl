        ...
        <div>
            <table border="0" width="100%" cellpadding="3" cellspacing="0">
                <tr>
                    ...
                    <td width="100"><b>{l s='Feed name:' mod='xmlfeeds'}</b></td>
                    <td>
                        {$feed.name|escape:'htmlall':'UTF-8'}
                    </td>
                </tr>
                <tr>
                    <td width="20"><img src="{$moduleImgPath|escape:'htmlall':'UTF-8'}statsettings.gif" /></td>
                    <td width="80"><b>{l s='Total views:' mod='xmlfeeds'}</b></td>
                    <td>
                        {$feed.total_views|escape:'htmlall':'UTF-8'}
                    </td>
                </tr>
                <tr><td>&nbsp;</td></tr>
            </table>
        ...
        {if !empty($stat)}
            <div class="blmod_clicks_list">
                <div id="blmod_clicks_title" class="blmod_clicks_row blmod_clicks_title">
                    <div class="blmod_clicks_ip"><a href="{$full_address_no_t|escape:'htmlall':'UTF-8'}&statistics={$statistics|escape:'htmlall':'UTF-8'}&order_name=ip_address{$order|escape:'htmlall':'UTF-8'}{$token|escape:'htmlall':'UTF-8'}">{l s='User IP' mod='xmlfeeds'}</a></div>
