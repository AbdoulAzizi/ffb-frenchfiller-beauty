            ...
            <div class="panel">
                ...
                <div class="row">
                    ...
                    {if empty($productListId)}
                        ...
                        <input style="" type="submit" name="add_product_list" value="{l s='Create new list' mod='xmlfeeds'}" class="button">
                        <div class="cb"><br></div>
                        <hr>
                    {/if}
                                    ...
                                    {foreach $productList.products as $p}
                                        <li class="search_p_list" id="search_p-{$p.id_product|escape:'htmlall':'UTF-8'}">
                                            <div title="{l s='Remove' mod='xmlfeeds'}" class="search_drop_product product-list-row" id="search_drop-{$p.id_product|escape:'htmlall':'UTF-8'}">
                                                <img alt="{l s='Delete' mod='xmlfeeds'}" src="{$moduleImgPath|escape:'htmlall':'UTF-8'}delete.gif">
                                            </div>
                ...
                <div class="panel">
                    ...
                    <div class="row">
                        <div class="">
                            ...
                            <input style="float: left; margin-left: 4px; margin-top: 2px;" type="submit" name="load_product_category" value="{l s='Load products' mod='xmlfeeds'}" class="button">
                            <div class="cb"><br></div>
                        </div>
