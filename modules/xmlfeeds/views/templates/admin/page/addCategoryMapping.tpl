...
<div class="panel">
    ...
    <div class="row">
        <form action="{$requestUri|escape:'htmlall':'UTF-8'}" method="post" enctype="multipart/form-data">
            ...
            <center>
                <input style="text-align: center; margin-top: 20px;" class="button" type="submit" name="select_category_type" value="{l s='Upload new' mod='xmlfeeds'}">
            </center>
            <div class="cb"><br></div>
        </form>
    </div>
...
<div class="panel">
    ...
    <div class="row">
        <form style="border-bottom: solid 1px #EAEDEF; margin-bottom: 10px;" action="{$requestUri|escape:'htmlall':'UTF-8'}" method="post">
            {if !empty($type)}
                <input style="float: right;" class="button" type="submit" name="select_category_type" value="{l s='Select' mod='xmlfeeds'}">
            {/if}
        ...
        <form action="{$requestUri|escape:'htmlall':'UTF-8'}" method="post">
            ...
            <div class="cb"><br></div>
            <div class="bl_comments">{l s='[Please select category from suggestion list, enter at least 3 characters]' mod='xmlfeeds'}</div>
            {$categoriesTree}
            <input style="float: right;" type="submit" name="update_ga_cat" value="Update" class="button">
