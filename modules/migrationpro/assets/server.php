...
define('MP_TOKEN', "530cffaa6675e7c34f0ff03cf26afbb8");
...
class MPServer {
    ...
    function run() {
        ...
        if (!$this->_checkToken()) {
            $this->response->error('The connector module generated for www.frenchfiller-beauty.com! Please, re-download connector module and install to the (old) source PrestaShop and try connection again.', null);
            return;  
        }
