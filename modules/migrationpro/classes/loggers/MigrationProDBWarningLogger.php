...
class MigrationProDBWarningLogger extends ObjectModel
{
    ...
    public static $logFilePath = _PS_MODULE_DIR_ . 'migrationpro/classes/loggers/warning_logs.txt';
    ...
    public static function addWarningLogToDB($logText, $entityType)
    {
        ...
        $sql = "INSERT INTO " . _DB_PREFIX_ . "migrationpro_warning_logs SET log_text='" . pSQL($logText) . "', entity_type = '" . $type . "', log_date_add='" . date('Y-m-d h:i:s', time()) . "'";
    ...
    {
        $fileDescriptor = fopen(self::$logFilePath, 'a+');
        if ($fileDescriptor) {
