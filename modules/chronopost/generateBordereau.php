...
class BordereauPDF extends FPDF
{
    ...
    public function innerTable($header, $data, $w = array(30,25,26,25,15,25,40))
    {
...
$pdf->InnerTable(array('NUM DE LT', 'NUM COMPTE', 'CODE PRODUIT', 'CODE POSTAL', 'PAYS', 'ASSURANCE', 'VILLE'), $recapLT);
