...
<div class="form-group">
	...
	<div class="col-lg-9 text-right">
		<button {if empty($available_accounts)}disabled="disabled"{/if} class="createCarrier btn btn-default" value="{$code|escape:'htmlall':'UTF-8'}"><i class="icon-plus"></i> {l s='Create new carrier' mod='chronopost'}</button>
	</div>
</div>
