...
<div id="bulkredirects" class="lgseoredirect-tabcontent">
    <fieldset>
        ...
        <form method="post" action="{$smarty.server.REQUEST_URI|escape:'htmlall':'UTF-8'}" enctype="multipart/form-data">
            ...
            <h3>
                <span class="lgfloat" style="margin-right: 20px;">
                    <label>
            ...
            <div>
                ...
                <button class="button btn btn-default" type="submit" style="float:right; margin-left:5px;" onclick="return confirm('Confirmation')" name="deleteAll">
