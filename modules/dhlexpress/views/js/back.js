...
function checkDhlCredentials(btn, login, password, mode) {
    var $icon = btn.find('i');

    btn.toggleClass('disabled');
    $icon.toggleClass('icon-spin icon-spinner');
    $.ajax({
        type: 'POST',
        dataType: 'json',
...
$(document).ready(function () {
    ...
    $('button[name="checktestcredentials"]').on('click', function (e) {
        e.preventDefault();

        checkDhlCredentials($(this), $('#DHL_ACCOUNT_ID_TEST').val(), $('#DHL_ACCOUNT_PASSWORD_TEST').val(), 'test');
    });

    $('button[name="checkproductioncredentials"]').on('click', function (e) {
        e.preventDefault();

        checkDhlCredentials($(this), $('#DHL_ACCOUNT_ID_PRODUCTION').val(), $('#DHL_ACCOUNT_PASSWORD_PRODUCTION').val(), 'prod');
    });
