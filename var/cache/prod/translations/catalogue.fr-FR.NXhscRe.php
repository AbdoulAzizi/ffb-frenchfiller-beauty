...
$catalogue = new MessageCatalogue('fr-FR', array (
  ...
  'ModulesLeofeatureLeo_wishlist_button' => 
  array (
    'Remove from Wishlist' => 'Retirer des favoris',
    'Add to Wishlist' => 'Ajouter aux favoris',
  ),
  'ModulesWrdproductExtrafields' => 
  array (
    'my custom composition lang field wysiwyg' => 'Composition',
    'my custom utilisation lang field wysiwyg' => 'Mode d\'utilisation',
  ),
  'ShopThemeCatalog' => 
  array (
    'Custom Actifs' => 'Que contient-il ?',
    'Custom Utilisation' => 'Comment l\'utiliser ?',
    'Save %percentage%' => 'Économisez %percentage%',
    'Save %amount%' => 'Économisez %amount%',
    'Description' => 'Pourquoi on l\'aime ?',
    'Discount' => 'Remise',
  ...
  array (
    'Customer data privacy[1][2]%message%[/2]' => '%message%',
  ),
  'ModulesEmailsubscriptionShop' => 
  array (
    'Sign up for our newsletter[1][2]%conditions%[/2]' => 'Recevoir nos conseils, offres et ventes privées[1][2]%conditions%[/2]',
