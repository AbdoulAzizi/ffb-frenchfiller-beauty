...
{if $isLogged}
    ...
    <a class="account" href="{$my_account_url|escape:'html':'UTF-8'}" title="{l s='View My Account' d='Shop.Theme.Global'}" rel="nofollow">
        <i class="material-icons">&#xE7FD;</i>
    ...
    {else}
        ...
        {/if}
            <a href="javascript:void(0)" 
               ...
               aria-expanded="false"
               {/if}
               title="{l s='Quick Login' d='Shop.Theme.Global'}"
               rel="nofollow">
                <span>{l s='Sign In / Register' d='Shop.Theme.Global'}</span>
            </a>
        {if $leo_type == 'dropdown' || $leo_type == 'dropup'}
