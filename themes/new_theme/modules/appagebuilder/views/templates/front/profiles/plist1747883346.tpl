...
{/block}
{if isset($product.embedded_attributes.quantity_all_versions) && $product.embedded_attributes.quantity_all_versions == 0}
    <div class="wr-sale-stock"><span class="product-last-items"><span>{l s='sold out' d='Shop.Theme.Global'}</span></span></div>
{/if}</div>
